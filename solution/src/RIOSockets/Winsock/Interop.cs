...
namespace SXN.Net.Winsock
{
	internal static class Interop
	{
		...
		/// </summary>
		public const UInt16 AF_INET = 2;

		private const UInt32 IOC_IN = 0x80000000;

		private const UInt32 IOC_INOUT = IOC_IN | IOC_OUT;

		private const UInt32 IOC_OUT = 0x40000000;

		private const UInt32 IOC_WS2 = 0x08000000;

		/// <summary>
		/// </summary>
		public const Int32 IPPROTO_TCP = 6;

		public const UInt32 SIO_GET_MULTIPLE_EXTENSION_FUNCTION_POINTER = IOC_INOUT | IOC_WS2 | 36;

		/// <summary>
		/// Control code that allows to configure a TCP socket for faster operations on the loopback interface.
		/// </summary>
		public const UInt32 SIO_LOOPBACK_FAST_PATH = 0x98000010;
		...
		public static extern unsafe Int32 WSAIoctl
			(
			[In] IntPtr s,
